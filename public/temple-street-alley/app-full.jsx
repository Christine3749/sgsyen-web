  ...
  return (
    <div className="page" data-screen-label="01 封面 A" style={{ padding: 0, background: cream }}>
      ...
      <div style={{
        ...
        top: window.__WIDE_MODE ? 'calc(64% - 22px)' : '592px',
        height: '44px',
        lineHeight: '44px',
      }}>
        <div style={{
...
function CoverPageCyanB() {
  ...
  return (
    <div className="page" data-screen-label="01 封面 B" style={{ padding: 0, background: tealPale }}>
      ...
      <div style={{
        position: 'absolute', left: 40, right: 40,
        top: window.__WIDE_MODE ? 310 : 510,
        height: window.__WIDE_MODE ? 170 : 230,
...
function ContentsPage() {
  const items = [
    ...
    { p: '04', t: '线上怎么做 — AI 全域运营', s: '从 Agent 到城市级数据资产', n: '052' },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 24 }}>
          <div style={{ borderTop: '3px solid var(--ink)', paddingTop: 14 }}>
            <div className="eyebrow" style={{ marginBottom: 8 }}>第一类  ·  资方</div>
        ...
        <p className="body" style={{ fontSize: 14 }}>
          这本书叫<b>商业技术书</b>——把"AI 全域运营""Agent 赋能商户"
...
function ChapterOpenerPage() {
  return (
    <div className="page" data-screen-label="05 章节扉页" style={{ padding: 0, background: '#FAF4E6' }}>
      ...
      {/* 标题区 */}
      <div style={{ position: 'absolute', left: 40, right: 40, bottom: 165 }}>
        <div style={{
          fontFamily: 'var(--sans-en)', fontSize: 11, letterSpacing: '.32em',
      ...
      {/* 底部数字栏 */}
      <div style={{
        position: 'absolute', bottom: 76, left: 40, right: 40,
...
/* ========== 7. 章节正文 P2 — Agent 三层结构（信息图） ========== */
function ChapterBody2() {
  const layers = [
    {
      tag: 'L1',
      title: 'IP 层  ·  让摊主成为故事主角',
      en: 'IP LAYER · Story Agent',
      desc: '不是把摊主包装成网红。Agent 帮他梳理"为什么我做这个、做了多久、最骄傲的一锅汤是哪一锅"——故事是真的，叙事是 AI 写的。',
      examples: [
        '人物速写：3 分钟语音访谈 → 3 篇人物故事文案',
        '视觉风格库：摊位实景 → 抖音 / 小红书 / 视频号 三套封面',
        '声音 IP：海口话方言留存，AI 翻译成普通话字幕',
      ],
      tools: ['Claude', 'Midjourney', '即梦'],
    },
    {
      tag: 'L2',
      title: '运营层  ·  内容与交易自动跑',
      en: 'OPERATION LAYER · Content & Commerce Agent',
      desc: '日更短视频、直播脚本、私域 SOP、看着买视频议价——这些过去需要 5 人团队的事，AI 工作流一次走完，摊主只需要按一下"发"。',
      examples: [
        '日更工厂：1 段实拍素材 → 抖音 / 小红书 / 视频号 9 条衍生',
        '私域机器人：扫码进群 → 7 日复购提醒 → 老客唤醒',
        '看着买：1 对 1 视频议价 + AI 称重 + 区块链存证',
      ],
      tools: ['Codex', 'Cloud Code', 'Dify', 'Sora / 可灵'],
    },
    {
      tag: 'L3',
      title: '管理层  ·  让数据说话',
      en: 'MANAGEMENT LAYER · Insight Agent',
      desc: '哪个摊位该换位置、哪个品类要加强、哪条街动线有问题——不靠拍脑袋，靠 Agent 跑出的城市消费热力图。这是给商户看的，也是给政府交的。',
      examples: [
        '人流热力：摄像头 + AI 视觉 → 30 分钟级动线优化',
        '品类雷达：交易数据 → 周报"该上什么、该下什么"',
        '政府交付：本地留存的城市消费大数据地图',
      ],
      tools: ['数据大模型', '区块链存证', 'PowerBI'],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <p className="body" style={{ marginBottom: 16, color: 'var(--smoke)', fontSize: 13 }}>
        ...
        {layers.map((L, i) => (
          <div key={i} style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 10 }}>
              <div className="num" style={{ fontSize: 32, color: 'var(--vermilion)', fontWeight: 600, lineHeight: 1 }}>
                {L.tag}
              </div>
              <div className="caption" style={{ fontSize: 9, letterSpacing: '.2em' }}>{L.en}</div>
            </div>
            <h4 style={{ fontFamily: 'var(--serif-zh)', fontSize: 14, fontWeight: 700, margin: '0 0 8px 0', lineHeight: 1.4 }}>
              {L.title}
            </h4>
            <p style={{ fontFamily: 'var(--serif-zh)', fontSize: 11.5, lineHeight: 1.7, color: 'var(--smoke)', margin: '0 0 12px 0' }}>
              {L.desc}
            </p>
            <div className="rule" style={{ margin: '4px 0 10px' }} />
            <div className="caption" style={{ fontWeight: 700, color: 'var(--ink)', marginBottom: 6, letterSpacing: '.18em', fontSize: 9 }}>
              典型动作
            </div>
            <ul style={{ margin: 0, padding: 0, listStyle: 'none' }}>
              {L.examples.map((e, j) => (
                <li key={j} style={{
                  fontFamily: 'var(--serif-zh)', fontSize: 10.5, lineHeight: 1.55,
                  color: 'var(--ink)', marginBottom: 6, paddingLeft: 12, position: 'relative',
                }}>
                  <span style={{
                    position: 'absolute', left: 0, top: 7,
                    width: 5, height: 5, background: 'var(--vermilion)',
                  }} />
                  {e}
                </li>
              ))}
            ...
            <div style={{ marginTop: 'auto', paddingTop: 12 }}>
              {L.tools.map((t, j) => (
                <span key={j} className="tag v" style={{ fontSize: 9 }}>{t}</span>
              ))}
            </div>
          </div>
        ))}
      ...
      {/* 闭环图 */}
      <div style={{ marginTop: 22, display: 'flex', alignItems: 'center', gap: 12, padding: '14px 18px', background: 'var(--ink)', color: 'var(--paper)' }}>
        <div style={{ fontFamily: 'var(--sans-zh)', fontSize: 11, letterSpacing: '.28em', color: 'var(--gold)', fontWeight: 700 }}>
          闭环
        </div>
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10, fontFamily: 'var(--serif-zh)', fontSize: 13 }}>
          <span>L1 故事素材</span>
          ...
          <span>L3 管理大脑</span>
          <span style={{ color: 'var(--vermilion)' }}>→</span>
          <span style={{ color: 'var(--gold)' }}>反哺 L1（哪些故事在传播，加大投入）</span>
        </div>
      </div>
    </Page>
  );
  ...
  return (
    <div className="page dark" data-screen-label="12 封底" style={{ padding: 0 }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{
            width: 90, height: 32, background: 'var(--paper)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            padding: '0 5px',
          }}>
          ...
          <div className="caption" style={{ color: '#A8B0BD', textAlign: 'right', fontSize: 8, marginTop: 3, fontFamily: 'var(--sans-en)' }}>
...
/* ========== 主导航 ========== */
function App() {
  const isWide = !!window.__WIDE_MODE;
  ...
  const pages = [
    ...
    { c: <window.ExecSummaryPage />,       label: '执行摘要' },
    { c: <window.Ch1OpenerPage />,         label: '01 扉页' },
    { c: <window.Ch1BodyPage />,           label: '01 正文' },
    { c: <window.Ch2OpenerPage />,         label: '02 扉页' },
    { c: <window.Ch2BodyPage />,           label: '02 正文' },
    { c: <window.Ch3OpenerPage />,         label: '03 扉页' },
    { c: <window.Ch3Body1Page />,          label: '03 正文1' },
    { c: <window.Ch3Body2Page />,          label: '03 正文2' },
    { c: <ChapterOpenerPage />,            label: '04 扉页' },
    { c: <ChapterBody1 />,                 label: '4.1 命题' },
    { c: <ChapterBody2 />,                 label: '4.2 三层' },
    { c: <ChapterBody3 />,                 label: '4.3 模块' },
    { c: <ChapterBody4 />,                 label: '4.4 路线' },
    { c: <ChapterBody5 />,                 label: '4.6 政府' },
    { c: <ChapterEndPage />,               label: '4.7 小结' },
    { c: <window.Ch5OpenerPage />,         label: '05 扉页' },
    { c: <window.Ch5Body1Page />,          label: '05 收入流' },
    { c: <window.Ch5Body2Page />,          label: '05 三方' },
    { c: <window.Ch6OpenerPage />,         label: '06 扉页' },
    { c: <window.Ch6BodyPage />,           label: '06 团队' },
    { c: <window.Chapter07Opener />,       label: '07 扉页' },
    { c: <window.Chapter07Body1 />,        label: '07 纪律' },
    { c: <window.Chapter07Body2 />,        label: '07 风控' },
    { c: <window.Ch8OpenerPage />,         label: '08 扉页' },
    { c: <window.Ch8Body1Page />,          label: '08 融资模型' },
    { c: <window.Ch8Body2Page />,          label: '08 资金用途' },
    { c: <window.Ch9OpenerPage />,         label: '09 扉页' },
    { c: <window.Ch9BodyPage />,           label: '09 民生' },
    { c: <window.Ch10OpenerPage />,        label: '10 扉页' },
    { c: <window.Ch10Body1Page />,         label: '10 扩张' },
    { c: <window.Ch10Body2Page />,         label: '10 终局' },
    { c: <window.Ch11OpenerPage />,        label: '11 扉页' },
    { c: <window.Ch11Body1Page />,         label: '11 SEO→GEO' },
    { c: <window.Ch11Body2Page />,         label: '11 数据架构' },
    { c: <window.Ch11Body3Page />,         label: '11 实施' },
    { c: <window.Ch11Body4Page />,         label: '11 指标' },
    { c: <window.Ch12OpenerPage />,        label: '12 扉页' },
    { c: <window.Ch12Body1Page />,         label: '12 本土优势' },
    { c: <window.Ch12Body2Page />,         label: '12 海南贡献' },
    { c: <window.Ch12Body3Page />,         label: '12 全国扩张' },
    { c: <window.Ch12Body4Page />,         label: '12 如何操作' },
  ...
  useEffect(() => {
    if (!isWide) return;
    function calc() {
      setScale(Math.min((window.innerWidth - 140) / 680, (window.innerHeight - 60) / 960));
    }
    calc();
  ...
  if (isWide) {
    const arrow = (onClick, icon, side, disabled) => (
      <button onClick={onClick} disabled={disabled} style={{
        position: 'fixed', [side]: 0, top: 0, bottom: 0, width: 64,
        background: 'transparent', border: 'none', zIndex: 100,
        cursor: disabled ? 'default' : 'pointer',
        color: disabled ? 'transparent' : 'rgba(255,255,255,0.18)',
        fontSize: 44, display: 'flex', alignItems: 'center', justifyContent: 'center',
        transition: 'color 0.2s',
      }}
        onMouseEnter={e => { if (!disabled) e.currentTarget.style.color = 'rgba(255,255,255,0.65)'; }}
        onMouseLeave={e => { if (!disabled) e.currentTarget.style.color = 'rgba(255,255,255,0.18)'; }}
      >{icon}</button>
    );
    return (
      <div style={{ width:'100vw', height:'100vh', background:'#111', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center', position:'relative' }}>
        <div style={{ position:'fixed', top:16, left:20, color:'#555', fontFamily:'var(--sans-zh)', fontSize:11, letterSpacing:'.15em', zIndex:100 }}>
          {pages[page].label}
        </div>
        <div style={{ position:'fixed', top:16, right:20, color:'#555', fontFamily:'var(--sans-en)', fontSize:11, letterSpacing:'.2em', zIndex:100 }}>
          {String(page+1).padStart(2,'0')} · {String(pages.length).padStart(2,'0')}
        </div>
        <div style={{ transform:`scale(${scale})`, transformOrigin:'center center' }}>
          {pages[page].c}
        </div>
        {arrow(() => setPage(p => Math.max(p-1,0)),   '‹', 'left',  page===0)}
        {arrow(() => setPage(p => Math.min(p+1,pages.length-1)), '›', 'right', page===pages.length-1)}
        <div style={{ position:'fixed', bottom:14, left:'50%', transform:'translateX(-50%)', display:'flex', gap:4, alignItems:'center', zIndex:100 }}>
          {pages.map((_,i) => (
            <button key={i} onClick={() => setPage(i)} style={{
              width: i===page ? 20 : 5, height: 5, borderRadius: 3, padding: 0, border: 'none', cursor: 'pointer',
              background: i===page ? 'var(--vermilion)' : 'rgba(255,255,255,0.2)',
...
function PrintBook() {
  ...
  const allPages = [
    <CoverPage key="cover" />,
    <CopyrightPage key="copyright" />,
    <ContentsPage key="contents" />,
    <PrefacePage key="preface" />,
    <window.ExecSummaryPage key="exec" />,
    <window.Ch1OpenerPage key="ch1open" />,
    <window.Ch1BodyPage key="ch1body" />,
    <window.Ch2OpenerPage key="ch2open" />,
    <window.Ch2BodyPage key="ch2body" />,
    <window.Ch3OpenerPage key="ch3open" />,
    <window.Ch3Body1Page key="ch3b1" />,
    <window.Ch3Body2Page key="ch3b2" />,
    <ChapterOpenerPage key="ch4open" />,
    <ChapterBody1 key="ch4b1" />,
    <ChapterBody2 key="ch4b2" />,
    <ChapterBody3 key="ch4b3" />,
    <ChapterBody4 key="ch4b4" />,
    <ChapterBody5 key="ch4b5" />,
    <ChapterEndPage key="ch4end" />,
    <window.Ch5OpenerPage key="ch5open" />,
    <window.Ch5Body1Page key="ch5b1" />,
    <window.Ch5Body2Page key="ch5b2" />,
    <window.Ch6OpenerPage key="ch6open" />,
    <window.Ch6BodyPage key="ch6body" />,
    <window.Chapter07Opener key="ch7open" />,
    <window.Chapter07Body1 key="ch7b1" />,
    <window.Chapter07Body2 key="ch7b2" />,
    <window.Ch8OpenerPage key="ch8open" />,
    <window.Ch8Body1Page key="ch8b1" />,
    <window.Ch8Body2Page key="ch8b2" />,
    <window.Ch9OpenerPage key="ch9open" />,
    <window.Ch9BodyPage key="ch9body" />,
    <window.Ch10OpenerPage key="ch10open" />,
    <window.Ch10Body1Page key="ch10b1" />,
    <window.Ch10Body2Page key="ch10b2" />,
    <window.Ch11OpenerPage key="ch11open" />,
    <window.Ch11Body1Page key="ch11b1" />,
    <window.Ch11Body2Page key="ch11b2" />,
    <window.Ch11Body3Page key="ch11b3" />,
    <window.Ch11Body4Page key="ch11b4" />,
    <window.Ch12OpenerPage key="ch12open" />,
    <window.Ch12Body1Page key="ch12b1" />,
    <window.Ch12Body2Page key="ch12b2" />,
    <window.Ch12Body3Page key="ch12b3" />,
    <window.Ch12Body4Page key="ch12b4" />,
...
ReactDOM.createRoot(document.getElementById('root')).render(
  window.__PRINT_MODE ? <PrintBook /> : <App />
);
